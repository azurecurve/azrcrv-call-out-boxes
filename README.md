# [Call-out Boxes](https://development.azurecurve.co.uk/classicpress-plugins/call-out-boxes/)
...
* Rebuild plugin on the current azurecurve modular plugin pattern (namespaced includes/ files); no change to the call-out-box/cob shortcode tags, the call-out-box custom post type, or stored settings/template data.
