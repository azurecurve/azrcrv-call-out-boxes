 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_cob')){
	function azrcrv_create_plugin_menu_cob(){
		azrcrv_create_plugin_menu_table_cob();
		azrcrv_populate_plugin_menu_table_cob();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_cob')){
	function azrcrv_populate_plugin_menu_table_cob(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_cob')){
	function azrcrv_create_plugin_menu_table_cob(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
