...
<div class='azrcrv-donate'>
	<?php
		esc_html_e( 'Support', 'call-out-boxes' );
	?>
	...
	<span>
		<?php
		esc_html_e( 'You can help support the development of our free plugins by donating a small amount of money.', 'call-out-boxes' );
		?>
	</span>
</div>
