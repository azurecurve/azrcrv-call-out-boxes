...
<form method="post" action="admin-post.php">
	...
	<input type="submit" name="btn_save" value="<?php esc_attr_e( 'Save Settings', 'azrcrv-cob' ); ?>" class="button-primary"/>
</form>
<?php
/*
...
<div class='azrcrv-donate'>
	...
	<span>
		<?php
		esc_html_e( 'You can help support the development of our free plugins by donating a small amount of money.', 'azrcrv-cob' );
		?>
	</span>
</div>
